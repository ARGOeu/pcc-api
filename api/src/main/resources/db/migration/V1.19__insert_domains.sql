...
-- -------------------------------------------------
INSERT IGNORE INTO domain VALUES
(1,"scientific_domain-medical_and_health_sciences", "Medical & Health Sciences",
    "The science of dealing with the maintenance of health and the prevention and treatment of disease."),
 ( 2, "scientific_domain-agricultural_sciences", "Agricultural Sciences", "Sciences dealing with food and fibre production and processing. They include the technologies of soil cultivation, crop cultivation and harvesting, animal production, and the processing of plant and animal products for human consumption and use." ),
( 3, "scientific_domain-generic", "Generic", "Generic, Not targetting a specific domain."),
(4,"scientific_domain-engineering_and_technology", "Engineering & Technology","The application of science and mathematics by which the properties of matter and the sources of energy in nature are made useful to people."),
( 5,  "scientific_domain-natural_sciences" , "Natural Sciences","Any of the sciences (such as physics, chemistry, or biology) that deal with matter, energy, and their interrelations and transformations or with objectively measurable phenomena." ),
