...
public class EOSCPortalTest {
    ...
    public void updateEoscPortalDomains() throws ExecutionException, InterruptedException {
        ...
        eoscPortalDomain.id = "scientific_domain-medical_and_health_sciences";
        ...
        existPortalDomain.id = "scientific_domain-social_sciences";
        ...
        assertEquals(DomainMapper.INSTANCE.eoscPortalDomainToDomain(existPortalDomain), domainRepository.findById("scientific_domain-social_sciences"));
        assertEquals(DomainMapper.INSTANCE.eoscPortalDomainToDomain(eoscPortalDomain), domainRepository.findById("scientific_domain-medical_and_health_sciences"));
    }
}
